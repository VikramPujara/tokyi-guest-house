...
import { BedDouble, Coffee, Car, Wifi, Users } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    description:
      "Paid transportation on request service to and from the airport.",
  },
  {
...
export default function ServicesPage() {
  return (
    <>
      <BannerSection
        backgroundImage="/rooms/gardeen/10.jpg"
